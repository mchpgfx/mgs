...
leResult screenShow_Home(void)
{
    ...
    Home_ImageWidgetMCHPLogo->fn->setPosition(Home_ImageWidgetMCHPLogo, 810, 15);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 15, 525);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 764, 514);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 210, 237);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 406, 237);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 613, 236);
