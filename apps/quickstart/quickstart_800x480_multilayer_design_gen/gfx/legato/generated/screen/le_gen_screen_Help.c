...
leResult screenShow_Help(void)
{
    ...
    root1->fn->addChild(root1, (leWidget*)Help_LabelWidgetHelp);
    ...
    root1->fn->addChild(root1, (leWidget*)Help_ImageWidgetQRCode);
    ...
    root1->fn->addChild(root1, (leWidget*)Help_ImageWidgetMGSLogo);

    Help_ButtonWidgetGoHome = leButtonWidget_New();
    Help_ButtonWidgetGoHome->fn->setPosition(Help_ButtonWidgetGoHome, 550, 400);
    ...
    root1->fn->addChild(root1, (leWidget*)Help_ButtonWidgetGoHome);
